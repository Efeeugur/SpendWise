...
final class SupabaseService {
    ...
    // MARK: - Category Operations (from Enhanced)
    ...
    // MARK: - Budget Operations (from Enhanced)
    ...
    // MARK: - Financial Goals Operations (from Enhanced)
    ...
    // MARK: - Notifications Operations (from Enhanced)
    ...
    func markNotificationAsRead(id: UUID) async throws {
        let updateData: [String: Any] = ["is_read": true, "read_at": iso.string(from: Date())]
        let request = try makeRequest(
            path: "notifications",
            method: "PATCH",
            query: [URLQueryItem(name: "id", value: "eq.\(id)")],
    ...
    // MARK: - Bulk User Data Delete (from Enhanced)
